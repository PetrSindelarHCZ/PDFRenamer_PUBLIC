...
**Release Date:** listopadu 11, 2025

## What's New



 ? Allow GitHub to collect optional usage data to help us improve? This data does not include your queries.  [Use arrows to move, type to filter] > Yes   No  ? Allow GitHub to collect optional usage data to help us improve? This data does not include your queries. > Yes System.Management.Automation.RemoteException Γ£ù Error: No valid GitHub CLI OAuth token detected System.Management.Automation.RemoteException To get started with GitHub Copilot in the CLI, please run: gh auth login --web -h github.com to authenticate via web browser. System.Management.Automation.RemoteException
...
Download `PDFRenamer-Setup-1.25.315.2.exe` and run the installer.

**Alternatively**, download `PDFRenamer-1.25.315.2.zip` for manual deployment (contains MSI and CAB files).
...
2. **Run the installer** `PDFRenamer-Setup-1.25.315.2.exe`
...
See detailed commit history: https://github.com/PetrSindelarHCZ/PDFRenamer/compare/v{PREV_VERSION}...v1.25.315.2

## Assets

- 💿 **PDFRenamer-Setup-1.25.315.2.exe** - Recommended installer (includes .NET runtime)
- 📦 **PDFRenamer-1.25.315.2.zip** - Installation archive (MSI + CAB files for manual deployment)
